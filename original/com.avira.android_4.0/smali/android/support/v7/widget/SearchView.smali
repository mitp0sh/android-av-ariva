...
# interfaces
.implements Landroid/support/v7/a/c;


# static fields
.field private static final DBG:Z = false

.field static final HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/m;
...
.field private mOnCloseListener:Landroid/support/v7/widget/n;
...
.field private mOnQueryChangeListener:Landroid/support/v7/widget/o;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Landroid/support/v7/widget/p;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/m;
...
.method static synthetic access$100(Landroid/support/v7/widget/SearchView;)Landroid/support/v4/widget/a;
    .locals 1

    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/a;
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/q;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1560
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Landroid/support/v7/widget/m;
...
.method private onCloseClicked()V
    ...
    .line 1146
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/n;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/n;

    invoke-interface {v0}, Landroid/support/v7/widget/n;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1255
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/p;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/p;

    invoke-interface {v1}, Landroid/support/v7/widget/p;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1266
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/p;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/p;

    invoke-interface {v0}, Landroid/support/v7/widget/p;->a()Z
...
.method private onSubmitQuery()V
    ...
    .line 1126
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/o;
    ...
    invoke-interface {v1}, Landroid/support/v7/widget/o;->a()Z
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1117
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/o;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    .line 1309
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/a;
    ...
    .line 1315
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/a;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/a;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/q;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/a;
...
.method public setOnCloseListener(Landroid/support/v7/widget/n;)V
    .locals 0

    .prologue
    .line 491
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Landroid/support/v7/widget/n;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/o;)V
    .locals 0

    .prologue
    .line 482
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Landroid/support/v7/widget/o;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/p;)V
    .locals 0

    .prologue
    .line 509
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Landroid/support/v7/widget/p;
...
.method public setSuggestionsAdapter(Landroid/support/v4/widget/a;)V
    ...
    .prologue
    .line 703
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Landroid/support/v4/widget/a;
