...
# instance fields
.field private a:Landroid/support/v7/internal/view/menu/o;
...
.method public final a()V
    ...
    .prologue
    .line 54
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/r;->a:Landroid/support/v7/internal/view/menu/o;
    ...
    sget v4, Landroid/support/v7/appcompat/R$style;->Theme_AppCompat_CompactMenu_Dialog:I

    invoke-direct {v2, v3, v4}, Landroid/support/v7/internal/view/menu/m;-><init>(II)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/r;->b:Landroid/support/v7/internal/view/menu/m;

    .line 64
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/r;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v2, p0}, Landroid/support/v7/internal/view/menu/m;->a(Landroid/support/v7/internal/view/menu/ae;)V

    .line 65
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/r;->a:Landroid/support/v7/internal/view/menu/o;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/r;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v2, v3}, Landroid/support/v7/internal/view/menu/o;->a(Landroid/support/v7/internal/view/menu/ad;)V

    .line 66
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/r;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v2}, Landroid/support/v7/internal/view/menu/m;->a()Landroid/widget/ListAdapter;
    ...
    .line 69
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/o;->p()Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/r;->c:Landroid/app/AlertDialog;

    .line 83
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/r;->c:Landroid/app/AlertDialog;
    ...
    .line 75
    :cond_0
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/o;->o()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/o;->n()Ljava/lang/CharSequence;
...
.method public final a(Landroid/support/v7/internal/view/menu/o;Z)V
    ...
    .line 154
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/r;->b()V

    .line 156
    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/r;->d:Landroid/support/v7/internal/view/menu/ae;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/r;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/m;->a()Landroid/widget/ListAdapter;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/r;->c:Landroid/app/AlertDialog;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/view/menu/o;->a(Z)V
