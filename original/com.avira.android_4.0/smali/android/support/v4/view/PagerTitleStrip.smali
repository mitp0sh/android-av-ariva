...
.field private static final IMPL:Landroid/support/v4/view/an;
...
.field private final mPageListener:Landroid/support/v4/view/am;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->IMPL:Landroid/support/v4/view/an;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 61
    new-instance v1, Landroid/support/v4/view/am;

    invoke-direct {v1, p0, v0}, Landroid/support/v4/view/am;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->mPageListener:Landroid/support/v4/view/am;
...
.method private static setSingleLineAllCaps(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 108
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->IMPL:Landroid/support/v4/view/an;

    invoke-interface {v0, p0}, Landroid/support/v4/view/an;->a(Landroid/widget/TextView;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 251
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/aj;

    move-result-object v1

    .line 253
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->mPageListener:Landroid/support/v4/view/am;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Landroid/support/v4/view/bv;)Landroid/support/v4/view/bv;

    .line 254
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->mPageListener:Landroid/support/v4/view/am;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Landroid/support/v4/view/bu;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->updateAdapter(Landroid/support/v4/view/aj;Landroid/support/v4/view/aj;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Landroid/support/v4/view/bv;)Landroid/support/v4/view/bv;

    .line 265
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->mPager:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->setOnAdapterChangeListener(Landroid/support/v4/view/bu;)V
...
.method updateAdapter(Landroid/support/v4/view/aj;Landroid/support/v4/view/aj;)V
    .locals 1
    ...
    .line 317
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->mPageListener:Landroid/support/v4/view/am;

    invoke-virtual {p1, v0}, Landroid/support/v4/view/aj;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/aj;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->updateText(ILandroid/support/v4/view/aj;)V
...
.method updateText(ILandroid/support/v4/view/aj;)V
    .locals 6
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/aj;->getCount()I
    ...
    invoke-virtual {p2, v2}, Landroid/support/v4/view/aj;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/view/aj;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/aj;->getPageTitle(I)Ljava/lang/CharSequence;
...
.method updateTextPositions(IFZ)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/aj;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->updateText(ILandroid/support/v4/view/aj;)V
