...
.method private constructor <init>(Landroid/support/v4/view/PagerTitleStrip;)V
    ...
    .prologue
    .line 470
    iput-object p1, p0, Landroid/support/v4/view/am;->a:Landroid/support/v4/view/PagerTitleStrip;
...
.method synthetic constructor <init>(Landroid/support/v4/view/PagerTitleStrip;B)V
    ...
    .prologue
    .line 470
    invoke-direct {p0, p1}, Landroid/support/v4/view/am;-><init>(Landroid/support/v4/view/PagerTitleStrip;)V
...
.method public final a(I)V
    ...
    .line 485
    iget v1, p0, Landroid/support/v4/view/am;->b:I

    if-nez v1, :cond_1

    .line 487
    iget-object v1, p0, Landroid/support/v4/view/am;->a:Landroid/support/v4/view/PagerTitleStrip;

    iget-object v2, p0, Landroid/support/v4/view/am;->a:Landroid/support/v4/view/PagerTitleStrip;
    ...
    iget-object v3, p0, Landroid/support/v4/view/am;->a:Landroid/support/v4/view/PagerTitleStrip;

    iget-object v3, v3, Landroid/support/v4/view/PagerTitleStrip;->mPager:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v3}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/aj;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Landroid/support/v4/view/PagerTitleStrip;->updateText(ILandroid/support/v4/view/aj;)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/am;->a:Landroid/support/v4/view/PagerTitleStrip;
...
.method public final a(Landroid/support/v4/view/aj;Landroid/support/v4/view/aj;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/view/PagerTitleStrip;->updateAdapter(Landroid/support/v4/view/aj;Landroid/support/v4/view/aj;)V
