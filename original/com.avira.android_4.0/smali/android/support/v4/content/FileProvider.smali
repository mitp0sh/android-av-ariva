...
# instance fields
.field private b:Landroid/support/v4/content/e;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v4/content/e;
    .locals 10
    ...
    .line 213
    sget-object v3, Landroid/support/v4/content/FileProvider;->a:Ljava/util/HashMap;
    ...
    check-cast v0, Landroid/support/v4/content/e;
    :try_end_0
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/content/f;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v1}, Landroid/support/v4/content/f;->a(Ljava/lang/String;Ljava/io/File;)V
    :try_end_3
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/content/FileProvider;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v4/content/e;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/content/FileProvider;->b:Landroid/support/v4/content/e;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .prologue
    .line 195
    iget-object v0, p0, Landroid/support/v4/content/FileProvider;->b:Landroid/support/v4/content/e;

    invoke-interface {v0, p1}, Landroid/support/v4/content/e;->a(Landroid/net/Uri;)Ljava/io/File;
