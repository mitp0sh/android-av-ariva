.class final Lio/fabric/sdk/android/services/b/f;
...
.method public final a()Lio/fabric/sdk/android/services/b/b;
    ...
    invoke-direct {v2, v4}, Lio/fabric/sdk/android/services/b/g;-><init>(B)V
    ...
    .line 56
    :try_start_1
    iget-object v3, p0, Lio/fabric/sdk/android/services/b/f;->a:Landroid/content/Context;
    ...
    .line 58
    :try_start_2
    new-instance v3, Lio/fabric/sdk/android/services/b/h;

    invoke-virtual {v2}, Lio/fabric/sdk/android/services/b/g;->a()Landroid/os/IBinder;

    move-result-object v1

    invoke-direct {v3, v1}, Lio/fabric/sdk/android/services/b/h;-><init>(Landroid/os/IBinder;)V

    .line 60
    new-instance v1, Lio/fabric/sdk/android/services/b/b;

    invoke-virtual {v3}, Lio/fabric/sdk/android/services/b/h;->a()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3}, Lio/fabric/sdk/android/services/b/h;->b()Z

    move-result v3

    invoke-direct {v1, v4, v3}, Lio/fabric/sdk/android/services/b/b;-><init>(Ljava/lang/String;Z)V
    :try_end_2
    ...
    invoke-interface {v1}, Lio/fabric/sdk/android/q;->a()V
    ...
    invoke-interface {v3, v4, v5, v1}, Lio/fabric/sdk/android/q;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
